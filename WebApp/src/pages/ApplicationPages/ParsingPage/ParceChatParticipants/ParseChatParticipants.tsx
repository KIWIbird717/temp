...
import { Row, Col, Popover, Input, Checkbox, Divider, Modal, Button, Segmented } from "antd"
      ...
      >
        ...
        <div className="m-2 mt-9 flex justify-between">
          <Button
            type='link'
            danger={true}
            disabled={chanalLink.link || selectedFolder || checkBoxWrited || selectedAccountsFolder ? false : true}
            onClick={() => resetFields()}
          >
            Отмена
          </Button>
